  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 pb-20">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-6 sm:pt-10 mb-12 sm:mb-24">
          ...
          <div className="flex relative isolate items-start">
            ...
            >
              ...
              {/* Tiêu đề desktop */}
              <h3 className="hidden lg:block font-bold text-lg mb-6 text-black border-b-2
                             border-[#DB4444] inline-block pb-1 w-max">
                Danh mục sản phẩm
              </h3>
              ...
              <div className="flex flex-col text-sm font-medium text-gray-700 p-4 lg:p-0 lg:space-y-4">
                ...
                {menuItems.map((item, index) => (
                  <div key={index} className="group">
                          ...
                          <div key={ci}>
                            ...
                            <ul className="space-y-2">
                              {col.links.map((link, li) => (
                                <li key={li}>
                                  <a href="#"
                                     className="text-gray-500 hover:text-[#DB4444] transition-colors text-sm">
                                    {link}
                                  </a>
                                </li>
                              ))}
                    ...
                    {/* Mega Menu Desktop (Đã sửa lỗi đè Banner và tối ưu Grid tự động) */}
                          ...
                          <div key={ci}>
                            ...
                            <ul className="space-y-3">
                              {col.links.map((link, li) => (
                                <li key={li}>
                                  <a href="#"
                                     className="hover:text-[#DB4444] text-gray-500 transition-colors">
                                    {link}
                                  </a>
                                </li>
                              ))}
        ...
        {/* Lắp cái Banner Đen khổng lồ vào đây */}
        <PromoBanner />

        {/* Explore Our Products */}
        <ExploreProducts />

        {/* Lắp cái Banner Đen khổng lồ vào đây (nếu Duy có xài) */}
        {/* <FeaturedProductBanner /> */}

        {/* Lắp khối Bố cục Mới + 3 Icon Việt Hóa vào đây */}
        <FeaturedArrivals />
      </main>

      {/* LẮP FOOTER VÀO ĐÂY LÀ CHỐT SỔ */}
      <Footer />
